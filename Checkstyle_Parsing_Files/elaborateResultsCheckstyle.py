...
mainPath = "/Users/lujan/Desktop/thesis_work/Maltesque2020_code-smell-prediction/Checkstyle_Parsing_File_Outputs/monsterFileCheckstyle.csv"
...
exportDict(issueDict, 'issuesCheckstyle.csv')
exportDict(severitiesDict, 'severitiesCheckstyle.csv')
exportDict(typesDict, 'typesCheckstyle.csv')
