...
mainPath = "/Users/lujan/Desktop/thesis_work/Maltesque2020_code-smell-prediction/FindBugs_Parsing_File_Outputs/monsterFileFindBugs.csv"
...
exportDict(issueDict, 'issuesFindBugs.csv')
exportDict(severitiesDict, 'severitiesFindBugs.csv')
exportDict(typesDict, 'typesFindBugs.csv')
